    ...
    return (
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center">
          <div className="w-16 h-16 bg-red-600 rounded-lg flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-lg text-gray-400 font-light">Analyzing your preferences...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative z-10 px-6 py-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-4xl mx-auto leading-relaxed font-light">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-12">
            {recommendations.map((movie) => (
              <Card 
                key={movie.id} 
                className="bg-gray-900/60 backdrop-blur-sm border border-gray-800 hover:border-gray-700 transition-all duration-300 cursor-pointer group shadow-lg overflow-hidden rounded-lg"
                onClick={() => onMovieSelect(movie)}
              >
                <CardContent className="p-0">
                  <div className="aspect-[2/3] bg-gray-800 rounded-t-lg flex items-center justify-center relative overflow-hidden">
          ...
          <div className="text-center">
            <Button 
              onClick={onBack}
              className="bg-gray-800 hover:bg-gray-700 text-white border border-gray-700 px-8 py-3 text-base flex items-center gap-2 mx-auto rounded-md"
            >
